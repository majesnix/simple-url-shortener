...
const Terms = () => (
  <div>
    ...
    >
      ...
      <div style={{ width: '50%', fontSize: '1.7rem', paddingTop: '2rem' }}>
        ...
        <br />
        <br />
        In no event shall dcl.re or its suppliers be liable for any damages
        (including, without limitation, damages for loss of data or profit, or
        due to business interruption) arising out of the use or inability to use
        the materials on dcl.re's website, even if dcl.re or a dcl.re authorized
        ...
        <br />
        <br />
        The materials appearing on dcl.re website could include technical,
        typographical, or photographic errors. dcl.re does not warrant that any
        of the materials on its website are accurate, complete or current.
        dcl.re may make changes to the materials contained on its website at any
        time without notice. However dcl.re does not make any commitment to
        update the materials.
        <br />
        <br />
        dcl.re has not reviewed all of the sites linked to its website and is
        not responsible for the contents of any such linked site. The inclusion
        of any link does not imply endorsement by dcl.re of the site. Use of any
        such linked website is at the user's own risk.
        <br />
        <br />
        dcl.re may revise these terms of service for its website at any time
