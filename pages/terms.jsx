	...
	<div>
		...
		>
			...
			<div style={{ width: '50%', fontSize: 20, marginTop: 20 }}>
				...
				use or inability to use the materials on dcl.re's website, even if
				dcl.re or a dcl.re authorized representative has been notified
				...
				typographical, or photographic errors. dcl.re does not warrant
				that any of the materials on its website are accurate, complete
				or current. dcl.re may make changes to the materials contained on
				its website at any time without notice. However dcl.re does not
				make any commitment to update the materials.
				<br/><br/>
				dcl.re has not reviewed all of the sites linked to its website and is not
				responsible for the contents of any such linked site. The
				inclusion of any link does not imply endorsement by dcl.re of the
